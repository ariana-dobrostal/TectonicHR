...
<body>
    ...
    <#if potresi?size != 0>
        <#list potresi as earthquake>
            <div class="btnContainer" style="cursor: default;">
                <div class="potresTab">
                    <div class="tighterDiv"  onclick="location.href='/potres_admin/${earthquake.getIdPotres()}'">
                        <div class="atrHolder">
                    ...
                    <div class="atrWithBtn">
                        <button type="submit" onclick="confirmDeleteZadnjiPotres(${earthquake.getIdPotres()})" class="customBtn adminTabBtn"><span class="fa fa-trash customBars"></span></button>
                        <button type="submit" onclick="confirmPrebaciPotres(${earthquake.getIdPotres()})" class="customBtn adminTabBtn historyBtn"><span class="fa fa-history customBars"></span></button>
                    </div>
                </div>
            </div>
        </#list>
    ...
    <div class="btnContainer">
        <button type="button" class="customBtn" onclick="location.href = '/stariji_potresi_admin';">Stariji potresi</button>
    </div>
