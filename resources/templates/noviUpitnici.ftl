            ...
            <div class="btnContainer" name="upitnikId" value=${upitnik.getIdUpitnik()} ;">
                <div class="potresTab">
                    ...
                    <div class="atrWithBtn">
                         <button type="submit" class="customBtn adminTabBtn" onclick="confirmDeleteUpitnik(${upitnik.getIdUpitnik()})"><span class="fa fa-trash customBars"></span></button>
                         <button type="submit" onclick="location.href = '/dodijeli_upitnik/${upitnik.getIdUpitnik()}';" class="customBtn adminTabBtn historyBtn"><span class="fa fa-file customBars"></span></button>
                    </div>
                </div>
            </div>
        </#list>
    <#else>
        <p style="color: red; font-size: 36px; text-align: center;">Nema nedodijeljenih upitnika u bazi</p>
    </#if>
    <div class="btnContainer2">
        <button type="button" class="customBtn" onclick="location.href = '/novi_potres';">Novi potres</button>
    </div>
