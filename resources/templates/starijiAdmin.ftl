...
<body>
        ...
        <#list potresi as earthquake>
            <div class="btnContainer">
                <div class="potresTab">
                    ...
                    <div class="atrWithBtn">
                       <button type="submit" onclick="confirmDeletePotres(${earthquake.getIdPotres()})" class="customBtn adminTabBtn"><span class="fa fa-trash customBars"></span></button>
                    </div>
                </div>
            </div>
        </#list>
    ...
    <div class="btnContainer">
        <button type="button" class="customBtn" onclick="location.href = '/zadnji_potresi_admin';">Zadnji potresi</button>
    </div>
